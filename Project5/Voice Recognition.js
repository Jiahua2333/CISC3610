...
var about = "About I recognized. This website is about voice recognition. You can change something when you speak some keywords."
var help = "Help I recognized. You can say color, followed by a color, to set the circle color. " +
...
function Response() {
    ...
    if (key.localeCompare("color") == 0 || key.localeCompare("background") == 0) {
        if (!isNaN(color.match(/option/))) {
            ...
            var msg = new SpeechSynthesisUtterance("I heard you said " + request + " Sorry, I didn't recognize the color.");
            setTimeout(function () { window.speechSynthesis.speak(msg); }, 1000);
        }
    }
        ...
        if (!isNaN(option)) {
            ...
            var msg = new SpeechSynthesisUtterance("You are out of the range of the diameter, please make sure that greater than 1 and less than 300");
            setTimeout(function () { window.speechSynthesis.speak(msg); }, 1000);
        }
    }
        ...
        var msg = new SpeechSynthesisUtterance("Sorry. I can not recognized your voice. I heard you said " + request);
        setTimeout(function () { window.speechSynthesis.speak(msg); }, 1000);
